    ...
    <View style={styles.main}>
      <View style={{ flexDirection: "row", alignSelf: "flex-start" }}>
        ...
        <View style={{ justifyContent: "center", marginHorizontal: 10 }}>
          <Text style={{ fontSize: 18, marginBottom: 5 }}>Larry Hutchson</Text>
          <Text style={{ fontSize: 16, color: "grey" }}>Sales Executive</Text>
        </View>
      </View>
      <View
        style={{
